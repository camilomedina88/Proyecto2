...
/* *
 * websocket_write: write the string data to the destination wsi.
 */
                         ...
                         void *in, size_t len)
{
    ...
    switch (reason) {
        ...
        case LWS_CALLBACK_ESTABLISHED:
            ...
            websocket_write(wsi ,"{\"f_temp\":1, \"f_luz\":2, \"f_consol\":3, \"temp\":35.4, \"luz\":350}", -1);
            break;
        ...
        //     //websocket_write(wsi ,"Pailander!", -1);
        //     fread(line, sizeof(char), BUFF_SIZE, sensor);
        //     websocket_write(wsi ,line, -1);
        //     break;
